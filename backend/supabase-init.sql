-- Supabase initialization SQL (run in Supabase Dashboard -> SQL Editor)
-- This creates the app schema and seeds minimal default settings.
...
INSERT INTO settings (key, value) VALUES ('businessName', to_jsonb('Chicken Nation'::text)) ON CONFLICT (key) DO NOTHING;
INSERT INTO settings (key, value) VALUES ('branchName', to_jsonb('Main Branch'::text)) ON CONFLICT (key) DO NOTHING;
INSERT INTO settings (key, value) VALUES ('currency', to_jsonb('XAF'::text)) ON CONFLICT (key) DO NOTHING;
INSERT INTO settings (key, value) VALUES ('language', to_jsonb('en'::text)) ON CONFLICT (key) DO NOTHING;
INSERT INTO settings (key, value) VALUES ('theme', to_jsonb('dark'::text)) ON CONFLICT (key) DO NOTHING;
INSERT INTO settings (key, value) VALUES ('deliveryFee', to_jsonb(100::int)) ON CONFLICT (key) DO NOTHING;
